 ...
 * JAXP to load an XML file and create a DOM tree.Once the application obtains a
...
public class EchoParser
 {
	...
	{
        System.err.println("Usage: EchoParser [-options] <file.xml>");
    ...
    public static void main(String[] args) throws Exception
	{
        ...
        DocumentBuilderFactory dbf =
		  ...
		  System.err.println("The dbf object is "+dbf);
        ...
        DocumentBuilder db = dbf.newDocumentBuilder();
		  ...
		  System.err.println("The dbb object is "+db);
        ...
        Document doc = db.parse(new File(filename));
		  ...
		  System.err.println("The doc object is "+doc);
		    System.err.println("\n\n");
        ...
        EchoParser parser =  new EchoParser(new PrintWriter(outWriter, true));
		parser.echo(doc);
    }
