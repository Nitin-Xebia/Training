...
public class DynamicDispatchClient {
	public static void main(String[] args) throws MalformedURLException {
		...
		String endpointAddress = "http://localhost:8080/Soap12-FaultService/services/bankservice"; // web  service url
		QName serviceName = new QName("http://server.com/",
				"BankServiceService");// service name
		// Create a dynamic Service instance
		Service service = Service.create(serviceName);

		// QName for Port As defined in wsdl.
		QName portName = new QName("http://server.com/", "BankServicePort");
		...
		String xmlMessage = "<?xml version=\"1.0\" ?><S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\">"
				+ "<S:Body><ns2:getAccountName xmlns:ns2=\"http://server.com/\">"
				+ "</ns2:getAccountName></S:Body></S:Envelope>";
