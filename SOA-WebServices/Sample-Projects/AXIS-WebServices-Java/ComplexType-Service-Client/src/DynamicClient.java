...
public class DynamicClient {
	...
	public static void main(String[] args) throws RemoteException, ServiceException, MalformedURLException {
		   String endpoint = "http://localhost:8080/ComplexTypeService/services/BankService?wsdl";
		  ...
		  User  obj =   (User) call.invoke( new Object [] {new Integer(331)});
