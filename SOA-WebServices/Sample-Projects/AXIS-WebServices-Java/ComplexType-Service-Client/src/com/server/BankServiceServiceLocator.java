...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements com.server.BankServiceService {
    ...
    private java.lang.String BankService_address = "http://localhost:8080/ComplexTypeService/services/BankService";
    ...
    public com.server.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.server.BankServiceSoapBindingStub _stub = new com.server.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.server.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.server.BankServiceSoapBindingStub _stub = new com.server.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://server.com", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://server.com", "BankService"));
        }
