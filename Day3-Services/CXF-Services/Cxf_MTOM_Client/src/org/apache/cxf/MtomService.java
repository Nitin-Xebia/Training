...
@WebServiceClient(name = "MtomService", 
                  wsdlLocation = "http://localhost:8090/Cxf_MTOM_Attachments/services/MtomPort?wsdl",
...
public class MtomService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8090/Cxf_MTOM_Attachments/services/MtomPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MtomService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8090/Cxf_MTOM_Attachments/services/MtomPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
