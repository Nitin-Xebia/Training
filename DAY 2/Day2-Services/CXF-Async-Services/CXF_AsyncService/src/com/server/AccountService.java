...
public class AccountService extends Service {
    ...
    static {
        URL url = AccountService.class.getResource("bank.wsdl");
        if (url == null) {
            url = AccountService.class.getClassLoader().getResource("bank.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "bank.wsdl");
        }       
        WSDL_LOCATION = url;
    }
