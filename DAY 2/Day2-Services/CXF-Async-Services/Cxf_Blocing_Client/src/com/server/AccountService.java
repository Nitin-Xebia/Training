 ...
 * 2013-06-22T12:57:47.752+05:30
 * Generated source version: 2.6.8
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://localhost:8080/Cxf_Blocking_Service/services/AccountPort?wsdl",
...
public class AccountService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Cxf_Blocking_Service/services/AccountPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Cxf_Blocking_Service/services/AccountPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
