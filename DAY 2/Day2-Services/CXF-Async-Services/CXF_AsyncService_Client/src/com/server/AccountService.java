 ...
 * 2013-06-22T00:58:11.915+05:30
 * Generated source version: 2.6.8
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://localhost:8080/CXF_AsyncService/services/AccountPort?wsdl",
...
public class AccountService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/CXF_AsyncService/services/AccountPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/CXF_AsyncService/services/AccountPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
