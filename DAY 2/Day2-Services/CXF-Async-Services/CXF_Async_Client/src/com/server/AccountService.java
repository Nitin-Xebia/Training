 ...
 * 2013-06-21T22:54:45.189+05:30
 * Generated source version: 2.6.8
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://localhost:8080/CXF_DelayedService/services/AccountPort?wsdl",
...
public class AccountService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/CXF_DelayedService/services/AccountPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/CXF_DelayedService/services/AccountPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
