...
public class AccountServiceLocator extends org.apache.axis.client.Service implements com.server.AccountService {
    ...
    private java.lang.String AccountPort_address = "http://localhost:8080/CXF-Session-Service/services/AccountPort";
    ...
    public com.server.Bank getAccountPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.server.Bank getAccountPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.server.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
