...
@XmlType(name = "shipmentNotice", propOrder = {
    "itemList",
    "customerNumber",
    "itemMap",
    "orderNumber",
...
public class ShipmentNotice {
    ...
    protected ShipmentNotice.ItemMap itemMap;
    ...
    /**
     * Gets the value of the itemMap property.
     * 
     * @return
     *     possible object is
     *     {@link ShipmentNotice.ItemMap }
     *     
     */
    public ShipmentNotice.ItemMap getItemMap() {
        return itemMap;
    }

	/**
     * Sets the value of the itemMap property.
     * 
     * @param value
     *     allowed object is
     *     {@link ShipmentNotice.ItemMap }
     *     
     */
    public void setItemMap(ShipmentNotice.ItemMap value) {
        this.itemMap = value;
    }
    ...
    public static class ItemMap {
        ...
        protected List<ShipmentNotice.ItemMap.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ShipmentNotice.ItemMap.Entry }
         * 
         * 
         */
        public List<ShipmentNotice.ItemMap.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<ShipmentNotice.ItemMap.Entry>();
            }
            return this.entry;
        }
