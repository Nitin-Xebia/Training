...
public class ObjectFactory {
    ...
    private final static QName _GetCustomersByName_QNAME = new QName("http://customerservice.com/", "getCustomersByName");
    private final static QName _GetCustomersByNameResponse_QNAME = new QName("http://customerservice.com/", "getCustomersByNameResponse");
    private final static QName _NoSuchCustomer_QNAME = new QName("http://customerservice.com/", "NoSuchCustomer");
    private final static QName _UpdateCustomer_QNAME = new QName("http://customerservice.com/", "updateCustomer");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://customerservice.com/", name = "getCustomersByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://customerservice.com/", name = "getCustomersByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://customerservice.com/", name = "NoSuchCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://customerservice.com/", name = "updateCustomer")
