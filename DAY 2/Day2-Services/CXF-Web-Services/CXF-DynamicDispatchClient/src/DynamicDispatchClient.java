...
public class DynamicDispatchClient {
	public static void main(String[] args) throws MalformedURLException {
		...
		String endpointAddress = "http://localhost:8080/CXF_service1/services/AccountPort"; // web
																							// service
																							// url
		...
		String xmlMessage = "<?xml version=\"1.0\" ?>" +
				...
				"<S:Body><ns2:getDetails xmlns:ns2=\"http://server.com/\">" +
				"<arg0>11</arg0><arg1>AsokKumar</arg1></ns2:getDetails></S:Body>" +
				"</S:Envelope>";
