 ...
 * 2013-06-21T12:19:30.400+05:30
 * Generated source version: 2.6.8
 * 
 */
@WebServiceClient(name = "AccountService", 
                  wsdlLocation = "http://localhost:9090/CXF_service1/services/AccountPort?wsdl",
...
public class AccountService extends Service {
    ...
    public final static QName AccountPort =
    		new QName("http://server.com/", "AccountPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/CXF_service1/services/AccountPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/CXF_service1/services/AccountPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
