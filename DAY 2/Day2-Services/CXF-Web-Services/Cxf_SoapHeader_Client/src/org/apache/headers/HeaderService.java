 ...
 * 2013-06-30T22:14:36.953+05:30
 * Generated source version: 2.6.8
 * 
 */
@WebServiceClient(name = "HeaderService", 
                  wsdlLocation = "http://localhost:9090/Cxf_wsdl_SoapHeader_Test/services/SoapPort?wsdl",
...
public class HeaderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/Cxf_wsdl_SoapHeader_Test/services/SoapPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HeaderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Cxf_wsdl_SoapHeader_Test/services/SoapPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
